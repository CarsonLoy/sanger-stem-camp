...
A paper circuit is one of the simplest ways to introduce electronics. Using copper tape, a coin-cell battery, and an LED, students will build a complete electrical circuit on a piece of paper. Once the circuit is complete, the LED lights up without any programming or soldering.

The activity works well because students receive immediate feedback. If the LED lights, they know their circuit is complete. If it doesn't, they can inspect each connection and figure out where electricity is no longer able to flow.
...
- One printed circuit template, perferrably on carstock
...
Print one circuit template for every student using cardstock rather than ordinary printer paper. Cardstock is much more durable and holds the copper tape flat while students work.
...
Open each package of batteries ahead of time. Coin-cell batteries can be difficult for younger students to remove from their packaging.
...
![Prepared classroom materials](images/day1/paper-circuits/materials-laid-out.jpg)
...
1. Color their design before adding any electronics.
2. Place the copper tape along the printed circuit paths.
3. Fold the battery flap.
4. Insert the battery.
5. Place the LED through the paper.
6. Tape the battery closed.
7. Test the circuit.
...
The LED only lights when electricity can travel in a complete loop from one side of the battery, through the LED, and back to the other side.
...
## The LED does not light
 ...
 Unlike a small incandescent bulb, an LED only works in one direction. First try flipping it around. If that doesn't solve the problem, just get a new bulb and test it using one of the cr2032 batteries used for the circuts.
...
![Troubleshooting example](images/day1/paper-circuits/troubleshooting.jpg)
...
![Completed student projects](images/day1/paper-circuits/completed-projects.jpg)
